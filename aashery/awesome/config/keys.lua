...
keys.globalkeys = gears.table.join(
    ...
    awful.key({ modkey }, "o", function () awful.spawn(apps.launcher, false) end, { description = "run app launcher" } ),
    awful.key({ modkey }, "l", function () awful.spawn(apps.locker, false) end, { description = "lock screen"} ),
    ...
    awful.key({}, "XF86AudioLowerVolume", function ()
        awful.spawn.easy_async_with_shell('amixer -D pipewire sset Master 3%-', function(stdout)
   ...
   awful.key({ }, "XF86MonBrightnessDown", function ()
       awful.spawn.easy_async_with_shell("light -U 3", function(stdout)
           awesome.emit_signal("popup::brightness", {amount = -3})
       end)
   end),
   awful.key({ }, "XF86MonBrightnessUp", function ()
       awful.spawn.easy_async_with_shell("light -A 3", function(stdout)
            awesome.emit_signal("popup::brightness", {amount = 3})
        end)
    end)
)
